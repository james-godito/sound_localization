...
# for testing performance of functions
def timer_func(func): 
...
def steering_delays(grid, mic_locs, max_bin=max_bin): # converts grid array to steering delay array of same shape
    '''
    Parameters
    ----------
    grid : ndarray
    ...
    # print("grid shaoe", np.shape(grid))
...
def main(): # for testing
    ...
    resolution = 11
    azi_range = np.linspace(10, 170, resolution)
    ele_range = np.linspace(45, 135, resolution)
