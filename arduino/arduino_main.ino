...
void setup()
{
  ...
  servo1.attach(LServo); // resets servos to default pos. (pointing front)
  servo1.write(90);
  servo2.attach(UServo);
  servo2.write(90);
...
void parseRawBytes() // for debugging, parses received data into readable data
{
